...
### Requirements:
1. Endpoints, which return random character from the world of Rick and Morty series.
2. Endpoints get "search_string" as an argument and return list of all characters,
...
4. Requests of implemented API should work with local DB
   (Take data  from DB not from Rick and Morty API).
